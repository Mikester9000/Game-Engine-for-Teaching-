...
**Total lessons:** 707 across 33 subsystems.

---

## Table of Contents

- [CMakeLists.txt](#cmakelists.txt) (21 lessons)
- [ci/workflows](#ciworkflows) (23 lessons)
- [editor/CMakeLists.txt](#editorcmakelists.txt) (7 lessons)
- [editor/src](#editorsrc) (50 lessons)
- [engine/assets](#engineassets) (11 lessons)
...
- [engine/rendering](#enginerendering) (133 lessons)
...
- [tools/cook](#toolscook) (8 lessons)
...
**Source:** [`CMakeLists.txt`](CMakeLists.txt#L297) (line 297)
...
**Source:** [`CMakeLists.txt`](CMakeLists.txt#L308) (line 308)
...
**Source:** [`CMakeLists.txt`](CMakeLists.txt#L361) (line 361)
...
**Source:** [`CMakeLists.txt`](CMakeLists.txt#L386) (line 386)
...
**Source:** [`CMakeLists.txt`](CMakeLists.txt#L413) (line 413)
...
**Source:** [`CMakeLists.txt`](CMakeLists.txt#L448) (line 448)
...
### Windows CI for a Vulkan engine

**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L5) (line 5)
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L14) (line 14)
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L42) (line 42)
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L67) (line 67)

v1.2.1 is required to avoid the deprecated actions/cache@v2 warning
that v1.2.0 triggered.  Always pin to a specific tag (not @main) for
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L92) (line 92)
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L100) (line 100)

The 'windows-debug-engine-only' configure preset sets binaryDir to
"${sourceDir}/build/${presetName}", so the output directory is
build/windows-debug-engine-only, not build/windows-debug.
Always derive the binary path from the preset name to avoid this
common CI mistake.
-----------------------------------------------------------------------
- name: Verify binaries exist
shell: pwsh
run: |
if (-not (Test-Path "build\windows-debug-engine-only\Debug\engine_sandbox.exe")) {
Write-Error "engine_sandbox.exe not found"
exit 1
}
if (-not (Test-Path "build\windows-debug-engine-only\Debug\cook.exe")) {
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L121) (line 121)
...
**Source:** [`.github/workflows/build-windows.yml`](.github/workflows/build-windows.yml#L131) (line 131)
...
run: .\build\windows-debug-engine-only\Debug\cook.exe --project samples\vertical_slice_project
...
**Source:** [`src/engine/assets/asset_db.cpp`](src/engine/assets/asset_db.cpp#L5) (line 5)
...
### Why nlohmann/json for production?

**Source:** [`src/engine/assets/asset_db.cpp`](src/engine/assets/asset_db.cpp#L28) (line 28)
...
**Source:** [`src/engine/assets/asset_db.cpp`](src/engine/assets/asset_db.cpp#L70) (line 70)
...
### Why a separate AssetDB vs. just reading AssetRegistry.json?

**Source:** [`src/engine/assets/asset_db.hpp`](src/engine/assets/asset_db.hpp#L20) (line 20)
...
**Source:** [`src/engine/assets/asset_db.hpp`](src/engine/assets/asset_db.hpp#L104) (line 104)
...
### rootDir normalisation

**Source:** [`src/engine/assets/asset_loader.cpp`](src/engine/assets/asset_loader.cpp#L21) (line 21)
...
**Source:** [`src/engine/assets/asset_loader.cpp`](src/engine/assets/asset_loader.cpp#L53) (line 53)
...
**Source:** [`src/engine/assets/asset_loader.cpp`](src/engine/assets/asset_loader.cpp#L66) (line 66)
...
### AssetLoader Design (M2 synchronous stub)
...
### Why return std::vector<uint8_t> (raw bytes)?

**Source:** [`src/engine/assets/asset_loader.hpp`](src/engine/assets/asset_loader.hpp#L22) (line 22)
...
**Source:** [`src/engine/core/Logger.cpp`](src/engine/core/Logger.cpp#L354) (line 354)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L52) (line 52)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L68) (line 68)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L99) (line 99)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L108) (line 108)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L137) (line 137)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L160) (line 160)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L175) (line 175)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L233) (line 233)
...
**Source:** [`src/engine/platform/win32/Win32Window.hpp`](src/engine/platform/win32/Win32Window.hpp#L261) (line 261)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L46) (line 46)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L79) (line 79)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L105) (line 105)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L159) (line 159)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L183) (line 183)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L235) (line 235)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L282) (line 282)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L295) (line 295)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L318) (line 318)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L344) (line 344)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L364) (line 364)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L387) (line 387)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L436) (line 436)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L453) (line 453)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L498) (line 498)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L518) (line 518)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L533) (line 533)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L565) (line 565)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L600) (line 600)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L625) (line 625)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L651) (line 651)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L665) (line 665)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L679) (line 679)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L730) (line 730)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L740) (line 740)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L750) (line 750)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L799) (line 799)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L833) (line 833)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L861) (line 861)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L886) (line 886)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L912) (line 912)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L943) (line 943)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L979) (line 979)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L1011) (line 1011)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L1093) (line 1093)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L1180) (line 1180)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L1253) (line 1253)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L1277) (line 1277)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.cpp`](src/engine/rendering/vulkan/VulkanRenderer.cpp#L1298) (line 1298)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L97) (line 97)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L110) (line 110)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L156) (line 156)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L183) (line 183)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L249) (line 249)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L263) (line 263)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L365) (line 365)
...
**Source:** [`src/engine/rendering/vulkan/VulkanRenderer.hpp`](src/engine/rendering/vulkan/VulkanRenderer.hpp#L383) (line 383)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_buffer.hpp`](src/engine/rendering/vulkan/vulkan_buffer.hpp#L67) (line 67)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_buffer.hpp`](src/engine/rendering/vulkan/vulkan_buffer.hpp#L96) (line 96)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_buffer.hpp`](src/engine/rendering/vulkan/vulkan_buffer.hpp#L114) (line 114)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_buffer.hpp`](src/engine/rendering/vulkan/vulkan_buffer.hpp#L153) (line 153)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_mesh.hpp`](src/engine/rendering/vulkan/vulkan_mesh.hpp#L64) (line 64)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_mesh.hpp`](src/engine/rendering/vulkan/vulkan_mesh.hpp#L123) (line 123)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_mesh.hpp`](src/engine/rendering/vulkan/vulkan_mesh.hpp#L145) (line 145)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_mesh.hpp`](src/engine/rendering/vulkan/vulkan_mesh.hpp#L157) (line 157)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_pipeline.hpp`](src/engine/rendering/vulkan/vulkan_pipeline.hpp#L76) (line 76)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_pipeline.hpp`](src/engine/rendering/vulkan/vulkan_pipeline.hpp#L103) (line 103)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_pipeline.hpp`](src/engine/rendering/vulkan/vulkan_pipeline.hpp#L129) (line 129)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_pipeline.hpp`](src/engine/rendering/vulkan/vulkan_pipeline.hpp#L152) (line 152)
...
**Source:** [`src/engine/rendering/vulkan/vulkan_pipeline.hpp`](src/engine/rendering/vulkan/vulkan_pipeline.hpp#L166) (line 166)
...
**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L5) (line 5)
...
**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L15) (line 15)
...
### Why read AssetRegistry.json (not discover files)?

**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L30) (line 30)
...
**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L132) (line 132)
...
### filesystem operations can throw on permission failures,

**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L192) (line 192)
...
**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L262) (line 262)
...
**Source:** [`src/tools/cook/cook_main.cpp`](src/tools/cook/cook_main.cpp#L349) (line 349)
...
### Build tools must report partial cook failures.
