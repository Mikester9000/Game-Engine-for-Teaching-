...
> **Current position: M19 (Action combat completion) ✅ complete. Cut-scene baker tool + editor panel ⬜. Next: M20 quest/dialogue tools + tests → M21–M22 tool gaps → M14 Vulkan.**
...
| **1 — Now** | **M20: Quest/dialogue tools + tests** | Quest baker; `--headless --scene quest_test` + `dialogue_test` CI |
