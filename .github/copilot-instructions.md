...
> **Current position: M21 (Tool stubs: nav-mesh baker + tod.lut baker) ✅ complete. Cut-scene baker tool + editor panel ⬜. Next: M22 tool gaps → M14 Vulkan.**
...
| **1 — Now** | **M22: Cinematic baker + editor panel** | `bake_cinematic()`; `CinematicEditorPanel` |
