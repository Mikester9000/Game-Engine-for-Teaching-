...
> **Current position: M20 (Quest/dialogue tools + tests) ✅ complete. Cut-scene baker tool + editor panel ⬜. Next: M21 nav-mesh baker + tod.lut baker → M22 tool gaps → M14 Vulkan.**
...
| **1 — Now** | **M21: Tool stubs** | Nav-mesh baker; tod.lut baker; pytest for each |
